...
async def cmd_start(message: types.Message):
    text = (
        ...
        "Балансы показываются только по запросу ('б' же 'баланс'). Меню төмөндө:"
    )
...
async def main():
    print("Bot started successfully with logs, bandit, records and giveaway!")
