...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    status = await update.message.reply_text("🔍 *Бот ищет трек...* 🎧", parse_mode=ParseMode.MARKDOWN)

    try:
        # SoundCloud аркылуу издөө (YouTube сыяктуу Render'ди блоктобойт, бот өзү таап берет)
        ydl_opts = {
