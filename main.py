...
# Сиздин администратордук ID'ңиз (Чексиз монета)
ADMIN_ID = 7978591176  
...
# Скриншоттогудай интерактивдүү меню клавиатурасы
...
# Скриншоттогудай рулетка интерфейсин чакыруу
...
# Досуна отметка кылып 10000 монета которуу (24 сааттык лимит)
...
# Ва-банк функциясы ("ва-банк к" же "ва-банк ч")
...
# Тексттик ставкалар (Мисалы: "2000 к", "1000 ч")
...
# Интерактивдүү кнопкаларды иштетүү
@dp.callback_query()
async def callback_handler(callback: types.CallbackQuery):
    ...
    if data == "bet_red_1k":
        ...
        await callback.message.answer("⏳ крутит рулетку...")
