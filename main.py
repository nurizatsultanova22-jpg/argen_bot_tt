...
async def cmd_start(message: types.Message):
    text = "Бот успешно запущен! Нижние кнопки убраны."
...
async def cmd_help(message: types.Message):
    help_text = "📖 Справка по командам: используйте слова вроде 'рулетка', 'профиль', 'стати', 'бандит' или команды."
...
async def spin_roulette(message: types.Message):
    ...
    # Сиз сураган монеталардын анимациясы (Видео/GIF шилтемеси)
    animation_url = "https://i.imgur.com/8X8X8X8.mp4" # Же өзүңүздүн видео файдыңыздын URL дареги
    anim_msg = None
    try:
        # Сиз жиберген скриншоттогу монеталар төгүлгөн көрүнүш үчүн видео шилтеме
