...
# КАДИМКИ message_handler ордуна business_message_handler колдонулат
...
async def handle(request):
    return web.Response(text="Business Assistant Bot is running!")
...
if __name__ == "__main__":
    ...
    print("Telegram Business жардамчы боту иштеди!")
