...
async def cmd_start(message: types.Message, state: FSMContext):
    ...
    welcome_text = (
        ...
        "Здесь вы можете найти любую музыку в самом высоком качестве (`320kbps`) и выбрать из нескольких вариантов. "
...
async def search_music_options(message: types.Message):
    ...
    waiting_msg = await message.answer("🎧 **Ищем треки (3 варианта)...** 🎶", parse_mode="Markdown")

    # YouTube'дун бөгөтүн айланып өтүү үчүн кошумча параметрлер
    ydl_opts = {
