...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    status = await update.message.reply_text("🔍 *Ищу на SoundCloud...* 🎧", parse_mode=ParseMode.MARKDOWN)

    try:
        # SoundCloud аркылуу издөө
        ydl_opts = {
        ...
        await status.edit_text("❌ *Не удалось найти файл на SoundCloud. Попробуй другое название!*", parse_mode=ParseMode.MARKDOWN)
