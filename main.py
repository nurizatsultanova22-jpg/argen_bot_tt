...
# Колдонуучулар акыркы жолу качан кат алганын сактоо (форматы: {user_id: "YYYY-MM-DD"})
...
# 2. Топтор үчүн (Сизди @mention кылганда)
@bot.message_handler(content_types=['text'], chat_type=['group', 'supergroup'])
