...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    status = await update.message.reply_text("🔍 *Ищу трек через прокси...* 🎧", parse_mode=ParseMode.MARKDOWN)

    try:
        # Invidious прокси колдонобуз, ол өзгөчө Render'дин бөгөтүн айланып өтөт
        ydl_opts = {
