...
bonus_limits = {}
give_money_limits = {} 
game_counter = 0  # Оюн санын эсептөө үчүн счетчик
...
async def cmd_start(message: types.Message):
    text = "Привет! Бот успешно запущен. Пожалуйста, поделитесь ботом со своими друзьями!"
...
async def cmd_help(message: types.Message):
    help_text = "📖 Справка: пишите 'рулетка', 'профиль', 'рекорд', 'бандит' или делайте ставки (например: `10000 1`)."
...
async def play_bandit(message: types.Message):
    ...
    # Арасында салам айтып, ботту таратууну сурануу (ар 5 оюн сайын чыгат)
    game_counter += 1
    if game_counter % 5 == 0:
        await message.answer("👋 Привет! Пожалуйста, поделитесь ботом со своими друзьями, чтобы играть вместе! 🚀")
...
async def spin_roulette(message: types.Message):
    ...
    # Рулетка бүткөндөн кийин да арасында саламдашып, ботту таратууну сурануу
    game_counter += 1
    if game_counter % 5 == 0:
        await message.answer("👋 Привет! Пожалуйста, поделитесь ботом со своими друзьями, чтобы играть вместе! 🚀")
...
async def main():
    print("Bot started successfully in Russian with automatic features!")
