...
# --- БАНДИТ (КАЗИНО СЛОТ СЕЙРЕК ЧЫГАТУУЧУ ЧОҢ УТУШТАР МЕНЕН) ---
...
async def play_bandit(message: types.Message):
    ...
    # Telegram слот жемиштери боюнча утуш шартталган (мисалы утканда):
    if val in [22, 43, 64]:
        # Утуш суммалары: 1000, 3000, 10000, 30000, 70000 (10000 ден жогорулары сейрек чыгат)
