...
# Өзүңүздүн Telegram ID'ңизди кашаанын ичине сан түрүндө жазыңыз (мисалы: {123456789})
# Эгер билбесеңиз, ботко кирип /id деп жазып билип алсаңыз болот.
ADMIN_IDS = {123456789}  
...
# --- ID КОМАНДАСЫ (Ким жазса да өз ID'син көрсөтөт) ---
...
async def start_game_handler(message: types.Message):
    ...
    # Автоматтык түрдө санды тандоо жана текшерүү
