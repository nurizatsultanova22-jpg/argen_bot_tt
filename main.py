...
def handle_business_message(message):
    ...
    # 2. OpenAI (ChatGPT) аркылуу адамдын сөзүнө акылдуу, адам сыяктуу жооп кайтаруу
    try:
    ...
    # 3. 30 секунддун ичинде Арген келбесе эскертүү берүү
    def check_and_reply():
        time.sleep(30)
...
if __name__ == "__main__":
    ...
    print("OpenAI кошулган жардамчы бот толук даяр болду!")
