...
async def callback_handler(callback: types.CallbackQuery):
    ...
    if data == "claim_bonus":
        ...
        await callback.answer(f"🎉 Вы успешно забрали ежедневную награду: +{reward} монет!", show_alert=True)
        return
    ...
    if data == "bet_red_1k":
        ...
        await spin_spin = await spin_roulette(fake_msg)
    await callback.answer()
