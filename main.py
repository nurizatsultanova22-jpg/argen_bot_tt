...
# «б» же «баланс» деп жазганда скриншоттогудай аты жана монеталар кошо чыгат
...
# --- БАНДИТ (КАЗИНО СЛОТ АНИМАЦИЯСЫ 3-4 СЕКУНД) ---
...
async def play_bandit(message: types.Message):
    ...
    # Telegram'дын анимированный слот кубиги (3-4 сек айланып токтойт)
