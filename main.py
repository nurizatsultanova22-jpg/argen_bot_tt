...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    ydl_opts = {'format': 'bestaudio/best', 'default_search': 'ytsearch5', 'quiet': True, 'noplaylist': True}
    entries = []
    ...
    # Ырдын сүрөтү (фона) бар биринчи вариантты же жалпы тизмени чыгаруу
    ...
    # Эгер сүрөт бар болсо, башына чоң фон кылып сүрөт чыгарабыз
